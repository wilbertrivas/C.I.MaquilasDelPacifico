...
public class Proveedor {
    ...
    public Proveedor(String nit, String digitoVerificacion, int sucursal, String nombre, String resolucionFacturacion, String fechaResolucion, int tipoProveedor_id, String telefono, String celular, String direccion, String correo, String ciudad, String observacion, int estado) {
        this.nit = nit;
