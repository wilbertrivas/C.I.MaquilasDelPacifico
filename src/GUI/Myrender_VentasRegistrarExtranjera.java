 ...
 * @author wilbert
 */
public class Myrender_VentasRegistrarExtranjera extends DefaultTableCellRenderer{
     private int columna_patron ;
     private String fecha ;
     
    public Myrender_VentasRegistrarExtranjera(int Colpatron, String fecha)
    {
        ...
        table.setForeground(Color.black);//color de texto
         try {
            ...
            if( diferenciaFecha(table.getValueAt(row,columna_patron).toString()).equals("VERDE"))  setBackground( new Color(173, 232, 156) );
             ...
             Logger.getLogger(Myrender_VentasRegistrarExtranjera.class.getName()).log(Level.SEVERE, null, ex);
         }
    ...
    public String diferenciaFecha(String fechaMaximaExportacion) throws ParseException{
        ...
        //System.out.println("Fecha: "+fecha +"Día Atraso: "+diasAtraso);
        if(diasAtraso >= 31){
            return "VERDE";
        }else{
