...
public class Cliente_Consultar extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 100, 1480, 510));
    ...
    public void tabla(String valorConsulta) throws SQLException{
        ...
        ControlDB_TipoCliente tipoCliente = new ControlDB_TipoCliente();
        ...
        for(int i =0; i< listadoCliente.size(); i++){
            ...
            registro[1]=""+listadoCliente.get(i).getDigitoVerificacion();
            registro[2]=""+listadoCliente.get(i).getSucursal();
            registro[3]=""+listadoCliente.get(i).getNombre();
            registro[4]=""+tipoCliente.validarTipoCliente_Nombre_por_ID(listadoCliente.get(i).getTipoCliente_id());
            registro[5]=""+listadoCliente.get(i).getTelefono();
            registro[6]=""+listadoCliente.get(i).getCelular();
            registro[7]=""+listadoCliente.get(i).getDireccion();
            registro[8]=""+listadoCliente.get(i).getCorreo();
            registro[9]=""+listadoCliente.get(i).getCiudad();
            registro[10]=""+listadoCliente.get(i).getObservacion();
            String estado=""+listadoCliente.get(i).getEstado();
            if(estado.equals("1")){
                estado="Activo";
            }else{
                estado="Inactivo";
