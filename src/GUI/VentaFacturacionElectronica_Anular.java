...
public class VentaFacturacionElectronica_Anular extends javax.swing.JPanel {
    ...
    String [] registro;  
    Usuario user;
    ControlDB_VentaFacturacionElectronica_AnulacionFactura  ObjetoAnulacionFactura ;
    ControlDB_Bodega  controlDB_Bodega ;
    ControlDB_VentaFacturacionElectronica_ParametrosGenerales ObjetoParametrosGenerales;

    public VentaFacturacionElectronica_Anular(Usuario u) throws SQLException {
        user= u;
        initComponents();  
        ObjetoAnulacionFactura = new ControlDB_VentaFacturacionElectronica_AnulacionFactura();
        controlDB_Bodega = new ControlDB_Bodega();
        ObjetoParametrosGenerales = new ControlDB_VentaFacturacionElectronica_ParametrosGenerales();
    ...
    private void initComponents() {
        ...
        jLabel8.setText("ANULAR FACTURAS DE VENTA A ELECTRÓNICA");
    ...
    private void consultarVentasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_consultarVentasActionPerformed
        ...
        if(validarConsulta){
            try {
                ...
                Logger.getLogger(VentaFacturacionElectronica_Anular.class.getName()).log(Level.SEVERE, null, ex);
            ...
            if(fila1==-1){
                ...
                try{
                    ...
                    if(!estado.equals("Activo")){
                        JOptionPane.showMessageDialog(null, "La factura a Computador ya se encuentra anulada, no se puede Anular");
                    }else{
        ...
        if(alertaColor.isSelected()){
            for(int i =0; i< listadoVentas.size(); i++){
                if(diferenciaFecha(listadoVentas.get(i).getFechaFactura()).equals(editColorSelect.getSelectedItem().toString())){
                    ...
                    registro[6]=""+ObjetoAnulacionFactura.retornarCantidadTotalFacturaVenta(listadoVentas.get(i).getId());
