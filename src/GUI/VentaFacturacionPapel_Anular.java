...
public class VentaFacturacionPapel_Anular extends javax.swing.JPanel {
    ...
    String [] registro;  
    Usuario user;
    ControlDB_VentaFacturacionPapel_AnulacionFactura  ObjetoAnulacionFactura ;
    ControlDB_Bodega  controlDB_Bodega ;
    ControlDB_VentaFacturacionPapel_ParametrosGenerales ObjetoParametrosGenerales;

    public VentaFacturacionPapel_Anular(Usuario u) throws SQLException {
        user= u;
        initComponents();  
        ObjetoAnulacionFactura = new ControlDB_VentaFacturacionPapel_AnulacionFactura();
        controlDB_Bodega = new ControlDB_Bodega();
        ObjetoParametrosGenerales = new ControlDB_VentaFacturacionPapel_ParametrosGenerales();
    ...
    private void initComponents() {
        ...
        jLabel8.setText("ANULAR FACTURAS DE VENTA A PAPEL");
    ...
    private void consultarVentasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_consultarVentasActionPerformed
        ...
        if(idVenta.isSelected()){
            if(editIdVenta.getText().equals("")){
                alertaGeneral.setText("Mensaje: El Código de Factura de Venta a Papel no puede estar Vacia");
        ...
        if(validarConsulta){
            try {
                ...
                Logger.getLogger(VentaFacturacionPapel_Anular.class.getName()).log(Level.SEVERE, null, ex);
            ...
            if(fila1==-1){
                ...
                try{
                    ...
                    if(!estado.equals("Activo")){
                        JOptionPane.showMessageDialog(null, "La factura a Papel ya se encuentra anulada, no se puede Anular");
                    }else{
