...
public class Proveedor_Consultar extends javax.swing.JPanel {
    DefaultTableModel modelo;
    String datos;
    String [] titulo= {"Nit", "Digito_Verificación","Sucursal" ,"Nombre", "Resolución_Factura","Fecha_Resolución","Tipo_Proveedor ","Teléfono", "Celular", "Dirección","Correo","Ciudad","Observacion","Estado"};
    String [] registro;
    Controladores.ControlDB_Proveedor ControlDB_Proveedor = new ControlDB_Proveedor();
          
    public Proveedor_Consultar() {
        initComponents(); 
    }
    ...
    private void initComponents() {
        ...
        jLabel8.setText("CONSULTAR PROVEEDORES");
        ...
        add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 50, 200, 30));
        ...
        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 110, 1490, 530));
    ...
    private void consultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_consultarActionPerformed
        try {
            ...
            Logger.getLogger(Proveedor_Consultar.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void jLabel1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel1MouseClicked
        /*try{
            ...
            gr.generarReporteProveedoresActivos();
    ...
    public void tabla(String valorConsulta) throws SQLException{
        ...
        ControlDB_TipoProveedor tipoProveedor = new ControlDB_TipoProveedor();
        ...
        for(int i =0; i< listadoProveedor.size(); i++){
            ...
            registro[1]=""+listadoProveedor.get(i).getDigitoVerificacion();
            registro[2]=""+listadoProveedor.get(i).getSucursal();
            registro[3]=""+listadoProveedor.get(i).getNombre();
            registro[4]=""+listadoProveedor.get(i).getResolucionFacturacion();
            registro[5]=""+listadoProveedor.get(i).getFechaResolucion();
            registro[6]=""+ tipoProveedor.validarTipoProveedor_Nombre_por_ID(listadoProveedor.get(i).getTipoProveedor_id());
            registro[7]=""+listadoProveedor.get(i).getTelefono();
            registro[8]=""+listadoProveedor.get(i).getCelular();
            registro[9]=""+listadoProveedor.get(i).getDireccion();
            registro[10]=""+listadoProveedor.get(i).getCorreo();
            registro[11]=""+listadoProveedor.get(i).getCiudad();
            registro[12]=""+listadoProveedor.get(i).getObservacion();
            String estado=""+listadoProveedor.get(i).getEstado();
            if(estado.equals("1")){
                estado="Activo";
            }else{
                estado="Inactivo";
    ...
    public void guardarPDF(String nombreArchivo){
        ...
        documento.setMargins(left, right, 0, bottom);
            ...
            fuente.setSize(12);
            Paragraph parrafo2 = new Paragraph("RESULTADOS ENCONTRADOS PROVEEDORES:", fuente);
            ...
            tablaG.addCell("RESOLUCIÓN FACTURA");
            tablaG.addCell("FECHA RESOLUCIÓN");
            ...
            for(int fila=0; fila<CantRegistro; fila++){  
                try{
                    ...
                    tablaG.addCell((String.valueOf(tabla.getValueAt(fila,11))));
                    tablaG.addCell((String.valueOf(tabla.getValueAt(fila,12))));
                }catch(Exception e){         
                }
            }
