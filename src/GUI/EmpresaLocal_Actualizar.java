...
public class EmpresaLocal_Actualizar extends javax.swing.JPanel {
    ...
    public EmpresaLocal_Actualizar(){
        initComponents();  
        ...
        tipoEmpresaLocal.setEnabled(false);
    ...
    private void initComponents() {
        ...
        jLabel7.setText("ACTUALIZAR EMPRESA LOCAL");
        ...
        add(tipoEmpresaLocal, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 120, 250, 30));
    ...
    private void buscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buscarActionPerformed
        try {
            ...
            Logger.getLogger(EmpresaLocal_Actualizar.class.getName()).log(Level.SEVERE, null, ex);
        }
        ...
        try{
            ...
            if(fila1==-1){
               JOptionPane.showMessageDialog(null,"no se ha seleccionando ninguna fila");
                ...
                tipoEmpresaLocal.setEnabled(true);
        ...
        if(nit.getText().equals("")){
            ...
            if(nombre.getText().equals("")){
                ...
                try{
                    ...
                    Controladores.ControlDB_EmpresaLocal ControlDB_EmpresaLocal = new ControlDB_EmpresaLocal();
                    Controladores.ControlDB_TipoEmpresaLocal ControlTipoEmpresaLocal = new ControlDB_TipoEmpresaLocal();
                    Controladores.ControlDB_Otros controlDB_Otros = new ControlDB_Otros();
                    int tipoEmpresaLocalC= ControlTipoEmpresaLocal.validarTipoEmpresaLocal_ID_por_Nombre(tipoEmpresaLocal.getSelectedItem().toString());
                    EmpresaLocal c = new EmpresaLocal();
                    ...
                    c.setTipoEmpresaLocal_id(tipoEmpresaLocalC);
                    ...
                    int result=0;
                    result=ControlDB_EmpresaLocal.actualizarEmpresaLocal(c);
                    if(result==1){
    ...
    public void tabla(String valorConsulta) throws SQLException{
        ...
        ArrayList<EmpresaLocal> listadoCliente=c.buscarEmpresaLocal(valorConsulta);
    ...
    public void consultarParaActualizar (EmpresaLocal client) throws SQLException{
        ControlDB_EmpresaLocal c = new ControlDB_EmpresaLocal();
        ArrayList<EmpresaLocal> listadoEmpresaLocal=c.consultarUnicoEmpresaLocal(client);
        for(int i =0; i< listadoEmpresaLocal.size(); i++){      
            nit.setText(""+listadoEmpresaLocal.get(i).getNit());
            digitoVerificacion.setText(""+listadoEmpresaLocal.get(i).getDigitoVerificacion());
            sucursal.setText(""+listadoEmpresaLocal.get(i).getSucursal());
            nombre.setText(""+listadoEmpresaLocal.get(i).getNombre());
            tipoEmpresaLocal.setSelectedIndex(listadoEmpresaLocal.get(i).getTipoEmpresaLocal_id()-1);;
            telefono.setText(""+listadoEmpresaLocal.get(i).getTelefono());
            celular.setText(""+listadoEmpresaLocal.get(i).getCelular());
            direccion.setText(""+listadoEmpresaLocal.get(i).getDireccion());
            correo.setText(""+listadoEmpresaLocal.get(i).getCorreo());
            ciudad.setText(""+listadoEmpresaLocal.get(i).getCiudad());
            observacion.setText(""+listadoEmpresaLocal.get(i).getObservacion());
            ControlDB_Otros controlOtros = new ControlDB_Otros();
            estado.setSelectedItem(controlOtros.convertidorEstadoID_x_Nombre(listadoEmpresaLocal.get(i).getEstado()));
        }
    }
}
