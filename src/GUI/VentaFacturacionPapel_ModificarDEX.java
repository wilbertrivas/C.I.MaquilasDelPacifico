...
import Controladores.ControlDB_VentaFacturacionPapel_ModificarDex;
...
public class VentaFacturacionPapel_ModificarDEX extends javax.swing.JPanel {
    ...
    String [] registro;  
    public VentaFacturacionPapel_ModificarDEX() throws SQLException {
        initComponents();  
    ...
    private void initComponents() {
        ...
        jLabel8.setText("CONSULTAR DE VENTAS A PAPEL");
    ...
    private void consultarVentasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_consultarVentasActionPerformed
        ...
        if(idVenta.isSelected()){
            if(editIdVenta.getText().equals("")){
                alertaGeneral.setText("Mensaje: El Código de Factura de Venta a Papel no puede estar Vacio");
        ...
        if(validarConsulta){
            try {
                ...
                Logger.getLogger(VentaFacturacionPapel_ModificarDEX.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void buscar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buscar1ActionPerformed
        ...
        ControlDB_VentaFacturacionPapel_ModificarDex controlDB_VentasModificarDex = new ControlDB_VentaFacturacionPapel_ModificarDex();
        try {
            int result= controlDB_VentasModificarDex.modificarDex(idFactura, DexNuevo);
            if(result == 1){
                JOptionPane.showMessageDialog(null, "La factura a Papel No."+idFactura+ " Se ha le ha modificador el DEX con exito");
            ...
            JOptionPane.showMessageDialog(null, "La factura a Papel No."+idFactura+ " No se ha le ha modificador el DEX, verifique información");
            Logger.getLogger(VentaFacturacionPapel_ModificarDEX.class.getName()).log(Level.SEVERE, null, ex);
        }
