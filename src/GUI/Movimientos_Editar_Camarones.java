...
import Controladores.ControlDB_Movimientos_Editar_Camarones;
...
public class Movimientos_Editar_Camarones extends javax.swing.JPanel {
    String valor="";
    Usuario user;
    ...
    public Movimientos_Editar_Camarones(Usuario u) {
        user= u;
        initComponents();
    ...
    private void initComponents() {
        ...
        VentanaBuscarDocumento.setTitle("Buscar Movimientos Camarones en Bodega");
        ...
        add(VentanaBuscarDocumento, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 70, 1450, 540));

        jLabel9.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel9.setForeground(new java.awt.Color(0, 102, 102));
        jLabel9.setText("EDITAR MOVIMIENTO DE CAMARONES EN BODEGA");
        ...
        BuscarCompra.setText("BUSCAR MOVIMIENTO CAMARONES");
    ...
    private void RegistrarMovimientoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RegistrarMovimientoActionPerformed
         try{
            ...
            if(filas <= 0){
                ...
                ControlDB_Movimientos_Editar_Camarones controlDB_Movimientos= new ControlDB_Movimientos_Editar_Camarones();
    ...
    private void botonBuscarDocumentoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonBuscarDocumentoActionPerformed
        ...
        try {
            ...
            Logger.getLogger(Movimientos_Editar_Camarones.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void Seleccionar_MovimientoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Seleccionar_MovimientoActionPerformed
        ...
        try{
            ...
            if(fila1==-1){
                ...
                ControlDB_Movimientos_Editar_Camarones controlDB_Movimientos= new ControlDB_Movimientos_Editar_Camarones();
                MovimientoProducto movimientoProducto =controlDB_Movimientos.consultarUnicoMovimientoProductoCamarones(Integer.parseInt(idMovimiento));
