...
public class Compra_Eliminar extends javax.swing.JPanel {
    ...
    String [] registro;  
    Usuario user;
    public Compra_Eliminar(Usuario u) throws SQLException {
        user= u;
        initComponents();  
    ...
    private void initComponents() {
        ...
        EliminarCompra = new javax.swing.JPopupMenu();
        ...
        jLabel8.setText("ELIMINAR COMPRA");
        ...
        tabla.setComponentPopupMenu(EliminarCompra);
    ...
    private void consultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_consultarActionPerformed
        ...
        if(validarConsulta){
            try {
                ...
                Logger.getLogger(Compra_Eliminar.class.getName()).log(Level.SEVERE, null, ex);
            ...
            if(fila1==-1){
                ...
                try{
                    ...
                    if(!cantidadInicial.equals(saldoBodega)){
                        ...
                        int resultado=controlDB_Compra.eliminarCompra(Integer.parseInt(id), user);
                        if(resultado == 1){
                            JOptionPane.showMessageDialog(null, "Eliminación de Compra Exitosa");
                            tabla("");
                        }else{
                            JOptionPane.showMessageDialog(null, "No se puede Eliminar la Compra, Porque presenta Movimientos");
                        }       
                    }
                }catch(Exception e){
    ...
    private javax.swing.JPopupMenu EliminarCompra;
    ...
    public void tabla(String script) throws SQLException, ParseException{
        ...
        ArrayList<IngresoProducto> listadoIngresoProducto=com.consultarCompras(script);
        ControlDB_Producto controlDB_Producto = new ControlDB_Producto();
        ControlDB_Bodega controlDB_Bodega = new ControlDB_Bodega();
