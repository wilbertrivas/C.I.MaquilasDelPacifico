...
public class Compra_Anular extends javax.swing.JPanel {
    DefaultTableModel modelo;
    String datos;
    String [] titulo= {"Entrada Alm. No","CP","Nit_Proveedor", "Nombre_Proveedor", "No_Factura","Bodega","Producto","Fecha_Compra","FechaMaxima_Exportación","Cant_Inicial","SaldoEnBodega","Estado"};
    String [] registro;  
    Usuario user;
    public Compra_Anular(Usuario u) throws SQLException {
        user= u;
        initComponents();  
    ...
    private void initComponents() {
        ...
        AnularCompra = new javax.swing.JPopupMenu();
        ...
        Editar.setText("Anular_Compra");
        Editar.setActionCommand("AnularCompra");
        Editar.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                EditarActionPerformed(evt);
            }
        });
        AnularCompra.add(Editar);
        ...
        add(consultar, new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 40, 140, 40));
        ...
        add(listar, new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 140, 140, 40));
        ...
        tabla.setComponentPopupMenu(AnularCompra);
        tabla.setFocusable(false);
        tabla.setSelectionBackground(new java.awt.Color(255, 102, 102));
        tabla.getTableHeader().setReorderingAllowed(false);
        jScrollPane1.setViewportView(tabla);

        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 210, 1480, 350));
        ...
        add(limpiar, new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 90, 140, 40));
        ...
        add(editColorSelect, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 180, 210, 30));
        ...
        add(jLabel15, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 20, 740, 190));
    ...
    private void consultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_consultarActionPerformed
        ...
        if(nombre.isSelected()){
            if(editNombre.getText().equals("")){
                ...
                if(Script.equals("")){
                    Script += " prov.[nombre] like '%"+editNombre.getText()+"%' ";
                }else{
                    Script += " and prov.[nombre] like '%"+editNombre.getText()+"%' ";
                }
            }
        }
        ...
        if(validarConsulta){
            try {
                if(nit.isSelected() || nombre.isSelected() || factura.isSelected() || compra.isSelected() || cp.isSelected() || bodega.isSelected() || producto.isSelected()){
                     tabla( " Where "+Script);
                }else{
                     tabla( "");
                }
                ...
                Logger.getLogger(Compra_Anular.class.getName()).log(Level.SEVERE, null, ex);
        ...
        try{
            ...
            if(fila1==-1){
                ...
                try{
                    ...
                    String cantidadInicial=(String)modelo.getValueAt(fila1, 9);
                    String saldoBodega=(String)modelo.getValueAt(fila1, 10);
                    ControlDB_Compra controlDB_Compra = new ControlDB_Compra();
                    if(!cantidadInicial.equals(saldoBodega)){
                        JOptionPane.showMessageDialog(null, "La cantidad Inicial de la compra y el saldo deben ser igual verifique que no presente movimiento");
                    }else{
                        String estadoCompra=(String)modelo.getValueAt(fila1, 11);
                        if(!estadoCompra.equalsIgnoreCase("Anulada")){
                            int resultado=controlDB_Compra.AnularCompra(Integer.parseInt(id), user);
                            if(resultado == 1){
                                 JOptionPane.showMessageDialog(null, "La Compra No."+id+ " Se ha anulado con exito");
                                tabla("");
                            }else{

                            }      
                        }else{
                            JOptionPane.showMessageDialog(null, "Error!!.. La Compra Ya se encuentra Anulada");
                        }
                    }
                }catch(Exception e){
    ...
    private javax.swing.JPopupMenu AnularCompra;
    ...
    public void tabla(String script) throws SQLException, ParseException{
        ...
        ArrayList<IngresoProducto> listadoIngresoProducto=com.consultarComprasActivasAnuladas(script);
        ControlDB_Producto controlDB_Producto = new ControlDB_Producto();
        ControlDB_Bodega controlDB_Bodega = new ControlDB_Bodega();
        
        /*String [] titulo= {"CP","Nit_Proveedor", "Nombre_Proveedor", 
            "No_Factura","Bodega","Producto","Fecha_Compra",
            "FechaMaxima_Exportación","Cant_Inicial","Saldo"};*/
        ...
        if(alertaColor.isSelected()){
            for(int i =0; i< listadoIngresoProducto.size(); i++){
               ...
               // BigDecimal saldo = new java.math.BigDecimal("0");
                //saldo.add(new java.math.BigDecimal(""+com.retornarSaldoIngresoProducto(Integer.parseInt(listadoIngresoProducto.get(i).getId()))));
                ...
                registro[11]=""+validarEstado(listadoIngresoProducto.get(i).getEstado());
