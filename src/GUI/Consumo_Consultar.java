...
public class Consumo_Consultar extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        VerConsumo = new javax.swing.JPopupMenu();
        ...
        jLabel8.setText("CONSULTAR CONSUMOS");
        ...
        tabla.setComponentPopupMenu(VerConsumo);
        tabla.setFocusable(false);
        tabla.setSelectionBackground(new java.awt.Color(255, 102, 102));
        tabla.getTableHeader().setReorderingAllowed(false);
        jScrollPane1.setViewportView(tabla);

        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 230, 1330, 390));
        ...
        add(alertaGeneral, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 140, 1060, 30));
    ...
    private void consultarVentasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_consultarVentasActionPerformed
        ...
        if(validarConsulta){
            try {
                ...
                Logger.getLogger(Consumo_Consultar.class.getName()).log(Level.SEVERE, null, ex);
            ...
            if(fila1==-1){
                ...
                try{
                    ...
                    if(estado.equals("Activo")){
                        ...
                        generarReportes.generar_ConsumoCamarones(Integer.parseInt(id)); 
                    }else{
                        if(estado.equals("Anulada")){
                            Generar_Reportes generarReportes = new Generar_Reportes();
                            generarReportes.generar_ConsumoAnulado(Integer.parseInt(id));
                        }
                    }                   
                }catch(Exception e){
    ...
    private javax.swing.JPopupMenu VerConsumo;
