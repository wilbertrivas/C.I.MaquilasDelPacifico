...
import Controladores.ControlDB_VentaFacturacionElectronica_RegistrarFacturaExtranjera;
import Controladores.ControlDB_VentaFacturacionElectronica_RegistrarFacturaNacional;
...
public class VentaFacturacionElectronica_Registrar_BodNacional extends javax.swing.JPanel {
    String valor="";
    String accion="";
    Usuario user;
    ...
    public VentaFacturacionElectronica_Registrar_BodNacional(Usuario u) {
        user= u;
        initComponents();
        ...
        //#########################################################
        ControlDB_VentaFacturacionElectronica_RegistrarFacturaExtranjera controlDB_Ventas = new ControlDB_VentaFacturacionElectronica_RegistrarFacturaExtranjera();
        try{
    ...
    private void initComponents() {
        ...
        add(VentanaInternaVentas, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 70, 1120, 410));
        ...
        jLabel9.setText("REGISTRO DE VENTA NACIONAL ELECTRÓNICA");
        add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 0, 510, 30));

        jLabel18.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel18.setText("Nit:");
        add(jLabel18, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 30, 80, 20));
        ...
        add(alertaDatosFactura, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 250, 1150, 30));
        ...
        add(cli_nit, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 30, 320, 20));
        ...
        add(fechaFactura, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 150, 270, 30));

        FacturaVentaNo.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        FacturaVentaNo.setText("Factura de Venta No.");
        add(FacturaVentaNo, new org.netbeans.lib.awtextra.AbsoluteConstraints(770, 0, 260, 30));
        ...
        add(CargarCliente, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 20, 100, 100));
        ...
        add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 190, 610, 70));

        jLabel27.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel27.setText("Dirección:");
        add(jLabel27, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 30, 70, 20));

        cli_direccion.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        cli_direccion.setForeground(new java.awt.Color(102, 102, 102));
        add(cli_direccion, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 30, 460, 20));

        jLabel31.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel31.setText("Correo:");
        add(jLabel31, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 50, 70, 20));

        cli_correo.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        cli_correo.setForeground(new java.awt.Color(102, 102, 102));
        add(cli_correo, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 50, 460, 20));

        jLabel32.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel32.setText("Ciudad:");
        add(jLabel32, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 70, 50, 20));

        cli_ciudad.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        cli_ciudad.setForeground(new java.awt.Color(102, 102, 102));
        add(cli_ciudad, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 70, 460, 20));
        ...
        add(cli_nombre, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 70, 320, 20));

        cli_telefono.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        cli_telefono.setForeground(new java.awt.Color(102, 102, 102));
        add(cli_telefono, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 90, 270, 20));

        jLabel12.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel12.setText("Fecha de Factura:");
        add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 150, 140, 30));

        jLabel36.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel36.setForeground(new java.awt.Color(102, 102, 102));
        jLabel36.setText("NACIONAL");
        add(jLabel36, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 150, 180, 30));

        jLabel38.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel38.setText("Bodega:");
        add(jLabel38, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 150, 230, 30));
        ...
        add(jScrollPane4, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 280, 1010, 150));
        ...
        add(RegistrarVentaExtranjera, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 450, 240, 60));
        ...
        add(alertaCliente, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 90, 770, 30));

        jLabel15.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "INFORMACIÓN DEL CLIENTE NACIONAL", javax.swing.border.TitledBorder.LEFT, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Adobe Arabic", 1, 14))); // NOI18N
        add(jLabel15, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 20, 1140, 130));
                            ...
                            if(validarQueCargueAlmenosUnCP()){//Validamos que se cargue al menos un CP, para poder Registrar la Venta.
                                ...
                                if(validarEnCPCargadosCantidadAVenderSeaMayorACero()){
                                    ...
                                    try {
                                        ...
                                        Logger.getLogger(VentaFacturacionElectronica_Registrar_BodNacional.class.getName()).log(Level.SEVERE, null, ex);
                                    }
                                    ...
                                    facturaVenta.setValorTotalEnPesosCalculados(new BigDecimal(sumatoriaValorTotalPesos.toPlainString()));
                                    facturaVenta.setValorTotalEnDolarCalculados(new BigDecimal("0"));
                                    //JOptionPane.showMessageDialog(null, facturaVenta.getValorTotalEnPesos());
                                    ControlDB_VentaFacturacionElectronica_RegistrarFacturaNacional controlDB_Ventas = new ControlDB_VentaFacturacionElectronica_RegistrarFacturaNacional();
                                    try {
                                        if(controlDB_Ventas.validorCantidadesExistentesBodegaNacional(ArrayItemFactura)){
                                            int valorW=controlDB_Ventas.registrarVentaNacional(facturaVenta, ArrayItemFactura,user);
                                            if(valorW==1){
                                                ...
                                                generarReportes.generar_FacturaVentaElectronicaNacional(controlDB_Ventas.retornarElMaximo());
                                                ...
                                                JOptionPane.showMessageDialog(null, "Error al registrar la Venta electrónica Nacional");    
                                            }
                                        }else{
                                            JOptionPane.showMessageDialog(null, "Error!!. No se puede Registrar la Venta electrónica Nacional, Verifique nuevamente todos los saldos en bodega debido a que han cambiado. Sugerencia Elimine los CP y vuelva a cargarlos");
                                        }   
    ...
    public void BuscarEnVentanaInterna() throws SQLException{
        switch(valor){
            ...
            case "CP":{
                ...
                modelo = new DefaultTableModel(null, titulo);
                ControlDB_VentaFacturacionElectronica_RegistrarFacturaNacional controlDB_Ventas= new ControlDB_VentaFacturacionElectronica_RegistrarFacturaNacional();
                ArrayList<IngresoProducto> listadoCp=controlDB_Ventas.consultarCpBodegaNacional(codigo.getText());
                for(int i =0; i< listadoCp.size(); i++){
                    ...
                    registro[2]=""+controlDB_Ventas.validarNombreBodegaNacional(""+listadoCp.get(i).getBodega_ingresoProductoInicial());
                    registro[3]=""+listadoCp.get(i).getCantidadInicial();
                    registro[4]=""+controlDB_Ventas.validarSaldoBodegaNacional(listadoCp.get(i).getId());
