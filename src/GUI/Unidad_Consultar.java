...
public class Unidad_Consultar extends javax.swing.JPanel {
    DefaultTableModel modelo;
    String datos;
    String [] titulo= {"Código","Nombre_Unidad", "Estado"};
    String [] registro;    
    
    public Unidad_Consultar() {
        initComponents();  
    }
    ...
    private void initComponents() {
        ...
        jLabel8.setText("CONSULTAR UNIDADES");
        ...
        add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 50, 180, 30));
        ...
        add(consultar, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 40, 140, 40));
        ...
        add(listar, new org.netbeans.lib.awtextra.AbsoluteConstraints(740, 40, 130, 40));
        ...
        add(limpiar, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 40, 130, 40));
    ...
    private void jLabel1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel1MouseClicked
        ...
        gr.generarReporteUnidadesActivas();
    ...
    public void tabla(String valorConsulta) throws SQLException{
        ...
        ControlDB_Unidad unid = new ControlDB_Unidad();
        ArrayList<Unidad> listadoUnidad=unid.buscarUnidad(valorConsulta);
        for(int i =0; i< listadoUnidad.size(); i++){
            registro[0]=""+listadoUnidad.get(i).getId();
            registro[1]=""+listadoUnidad.get(i).getDescripcion();
            String estado=""+listadoUnidad.get(i).getEstado();
            if(estado.equals("1")){
                estado="Activo";
            }else{
                estado="Inactivo";
    ...
    public void guardarPDF(String nombreArchivo){
        ...
        try{
            ...
            tablaG.addCell("CÓDIGO UNIDAD");
            tablaG.addCell("NOMBRE UNIDAD");
