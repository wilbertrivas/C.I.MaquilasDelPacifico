...
import Controladores.ControlDB_ConsumoCamarones_Editar_BodNacional;
import Controladores.ControlDB_EmpresaLocal;
import Controladores.ControlDB_Proveedor;
import Controladores.ControlDB_VentaFacturacionComputador_EditarFacturaNacional;
//import Controladores.ControlDB_Ventas_Editar_Factura_BodNacional;
...
public class ConsumoCamarones_Editar_BodNacional extends javax.swing.JPanel {
    String accion="";
    Usuario user;
    ...
    public ConsumoCamarones_Editar_BodNacional(Usuario u) {
        user= u;
        initComponents();
    ...
    private void initComponents() {
        ...
        add(VentanaInternaCp, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 80, 1220, 450));
        ...
        add(VentanaCPEliminados, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 80, 1220, 450));
        ...
        add(VentanaInternaClientes, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 80, 1220, 450));
        ...
        jLabel9.setText("BUSCAR CONSUMO");
        ...
        add(ConsumoNo, new org.netbeans.lib.awtextra.AbsoluteConstraints(760, 70, 260, 20));
        ...
        add(RegistrarVentaExtranjera, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 520, 240, 60));
        ...
        RegistrarVentaExtranjera1.setText("BUSCAR CONSUMO NACIONAL");
        ...
        add(RegistrarVentaExtranjera1, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 20, 320, -1));

        jLabel10.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel10.setForeground(new java.awt.Color(0, 102, 102));
        jLabel10.setText("REGISTRAR CONSUMO");
        ...
        add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 520, 190, 60));

        fechaConsumo.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                fechaConsumoMouseClicked(evt);
            }
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                fechaConsumoMouseEntered(evt);
            }
        });
        add(fechaConsumo, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 220, 230, 30));

        jLabel19.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel19.setText("Observación:");
        add(jLabel19, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 260, 120, 30));
        ...
        add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 260, 410, 70));

        jLabel14.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel14.setText("Factura:");
        add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 220, 140, 30));

        jLabel36.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel36.setForeground(new java.awt.Color(102, 102, 102));
        jLabel36.setText("NACIONAL");
        add(jLabel36, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 220, 180, 30));
        ...
        add(precioVentaKilo, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 260, 170, 30));
        ...
        add(jLabel16, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 210, 140, 30));
    }// </editor-fold>//GEN-END:initComponents

    private void CargarClienteMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_CargarClienteMouseClicked
        if(ConsumoNo.getText().equals("Consumo No.")){
            JOptionPane.showMessageDialog(null, "No se ha cargado un consumo para editar");
        }else{
    ...
    private void label_CargarCP2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_label_CargarCP2MouseClicked
        if(ConsumoNo.getText().equals("Consumo No.")){
            JOptionPane.showMessageDialog(null, "No se ha cargado el consumo para editar");
        }else{
            ...
            if(precioVentaKilo.getText().equals("")){
                ...
                try{
                    ...
                    if(Float.parseFloat(precioVentaKilo.getText()) <= 1000000){
                        try{
                            Calendar fecha = fechaConsumo.getCalendar();
                            ...
                            if(validarQueCargueAlmenosUnCP()){//Validamos que se cargue al menos un CP, para poder Registrar la Venta.
                                ...
                                if(validarEnCPCargadosCantidadAVenderSeaMayorACero()){//Validamos que las cantidades de los CP sea mayor a cero
                                    ...
                                    consumo.setCliente_sucursal(Integer.parseInt(cli_sucursal.getText()));
                                    ...
                                    try {
                                        ...
                                        Logger.getLogger(ConsumoCamarones_Editar_BodNacional.class.getName()).log(Level.SEVERE, null, ex);
                                    }
                                    consumo.setEmpresaLocal_nit(empresL.getNit());
                                    consumo.setEmpresaLocal_sucursal(empresL.getSucursal());
                                    //consumo.setTrm(Double.parseDouble("0"));
                                    ...
                                    ArrayList<ItemConsumoEditar> ArrayItemConsumoEditar= new ArrayList();
                                    ...
                                    for(int i=0; i< filasCarritoVentaCP; i++){
                                        ...
                                        ItemConsumoEditar item = new ItemConsumoEditar();
                                        item.setIdConsumo(idConsumoEdit);                 
                                        ...
                                        ArrayItemConsumoEditar.add(item);
                                    }
                                    consumo.setValorTotalEnPesos(new BigDecimal(sumatoriaValorTotalDolar.toPlainString()));
                                    //facturaVenta.setValorTotalEnDolarCalculados(new BigDecimal("0"));
                                    ControlDB_ConsumoCamarones_Editar_BodNacional controlDB_ConsumoEditar = new ControlDB_ConsumoCamarones_Editar_BodNacional();
                                    try {
                                        if(controlDB_ConsumoEditar.validorCantidadesExistentesBodegaNacional(ArrayItemConsumoEditar)){
                                            int valorW=controlDB_ConsumoEditar.registrarConsumoNacional(consumo, ArrayItemConsumoEditar,user);
                                            if(valorW==1){
                                                ...
                                                generarReportes.generar_ConsumoCamarones(consumo.getId());
                    ...
                    alertaDatosFactura.setText("ERROR!!.. El valor de precio por Kilo debe ser númerico, verifique datos ingresados");
                }
            }           
        }
    ...
    private void label_CargarClienteMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_label_CargarClienteMouseClicked
        if(ConsumoNo.getText().equals("Consumo No.")){
            JOptionPane.showMessageDialog(null, "No se ha cargado Consumo para editar");
        }else{
            VentanaInternaClientes.show(true);
            TextPrompt placeholder = new TextPrompt("Buscar por Nit o Nombre:", codigoClientes);
        ...
        try{
            ...
            if(fila1==-1){
                ...
                try{
                    ...
                    ControlDB_ConsumoCamarones_Editar_BodNacional controlDB_ConsumoCamarones_Editar_BodNacional = new ControlDB_ConsumoCamarones_Editar_BodNacional();
                    Consumo consumo =null;
                    ArrayList<ItemConsumo> listadoItemConsumo = null;    
                    Cliente cliente =null;
                    try{
                        consumo=controlDB_ConsumoCamarones_Editar_BodNacional.consultarUnicoConsumoNacional(idConsumo);
                        System.out.println(""+consumo.getId()+":"+consumo.getNombreQuienElabora());
                        listadoItemConsumo=controlDB_ConsumoCamarones_Editar_BodNacional.consultarItemConsumoNacional(idConsumo);
                        
                        
                        
                        Cliente c = new Cliente();
                        c.setNit(consumo.getCliente_nit());
                        c.setSucursal(consumo.getCliente_sucursal());
                        cliente= controlDB_ConsumoCamarones_Editar_BodNacional.retornarCliente(c);
                        
                        idConsumoEdit=consumo.getId();
                        ConsumoNo.setText("Consumo No. "+idConsumoEdit);
                        ...
                        String fechaFacturaV=consumo.getFechaConsumo();
                        SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd");
                        Date fechaFacturaX=dateFormat.parse(fechaFacturaV);
                                            
                        fechaConsumo.setDate(fechaFacturaX);
                        precioVentaKilo.setText(""+listadoItemConsumo.get(0).getValorUnitarioKilo());
                        observacion.setText(consumo.getObservaciones());
                        ...
                        for(int i =0; i< listadoItemConsumo.size(); i++){ 
                           ...
                           IngresoProducto ingresoProducto= controlDB_ConsumoCamarones_Editar_BodNacional.retornarCompra(listadoItemConsumo.get(i).getIdIngresoProducto());
                            //registroCPX[0]=listadoItemFacturas.get(i).getIdIngresoProducto());
                            registroCPX[0]=ingresoProducto.getCp();
                            
                            registroCPX[1]=controlDB_ConsumoCamarones_Editar_BodNacional.retornoNombreProducto(ingresoProducto.getProducto_id());
                            ...
                            proveedor= controlDB_ConsumoCamarones_Editar_BodNacional.retornarProveedor(p);
                            ...
                            cantidadEnBodega = cantidadEnBodega+ Integer.parseInt(controlDB_ConsumoCamarones_Editar_BodNacional.validarSaldoBodegaNacional(""+listadoItemConsumo.get(i).getIdIngresoProducto()));
                            cantidadEnBodega = cantidadEnBodega + Integer.parseInt(listadoItemConsumo.get(i).getCantidad().toPlainString()); //Le sumamos la cantidad dela ItemConsumo
                            registroCPX[6]=""+cantidadEnBodega;
                            registroCPX[7]=listadoItemConsumo.get(i).getCantidad().toPlainString();
                            registroCPX[8]="SI";
                        ...
                        JOptionPane.showMessageDialog(null, "No se pudo cargar el consumo");
                    }
    ...
    private void fechaConsumoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_fechaConsumoMouseClicked

    }//GEN-LAST:event_fechaConsumoMouseClicked

    private void fechaConsumoMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_fechaConsumoMouseEntered

    }//GEN-LAST:event_fechaConsumoMouseEntered
    ...
    public void BuscarEnVentanaInternaDocumentos(String valorConsulta) throws SQLException{               
        DefaultTableModel modelo;
        String [] titulo= {"No Consumo", "Fecha_Consumo","BodegaConsumo", "Nit_Cliente", "Nombre_Cliente", "Cant_Vendida", "valorTotalPesos", "nombreQuienElabora","Estado"};
        String [] registro = new String[9]; 
        modelo = new DefaultTableModel(null, titulo);     
        ArrayList<Consumo> listadoConsumo=null;
        ControlDB_ConsumoCamarones_Editar_BodNacional controlDB_ConsumoCamarones_Editar_BodNacional = null;
        if(valorConsulta.equals("")){
             controlDB_ConsumoCamarones_Editar_BodNacional = new ControlDB_ConsumoCamarones_Editar_BodNacional();
            listadoConsumo=controlDB_ConsumoCamarones_Editar_BodNacional.consultarConsumosCamaronesNacional(codigoDocumento.getText());
        }else{
            try{
                Integer.parseInt(codigoDocumento.getText());
                controlDB_ConsumoCamarones_Editar_BodNacional = new ControlDB_ConsumoCamarones_Editar_BodNacional();
                listadoConsumo=controlDB_ConsumoCamarones_Editar_BodNacional.consultarConsumosCamaronesNacional(" AND [consumo].[id]='"+codigoDocumento.getText()+"'");
            }catch(Exception e){
                alertaBuscarFacturaVenta.setText("Verifique valor Ingresado!! Debe ser Númerico");
                
            }
        }
        if(listadoConsumo !=null){
            for(int i =0; i< listadoConsumo.size(); i++){ 
                ...
                registro[3]=""+listadoConsumo.get(i).getCliente_nit();       
                    Cliente c = new Cliente();
                    c.setNit(listadoConsumo.get(i).getCliente_nit());
                    c.setSucursal(listadoConsumo.get(i).getCliente_sucursal());
                registro[4]=""+controlDB_ConsumoCamarones_Editar_BodNacional.consultarNombreCliente(c);    
                registro[5]=""+controlDB_ConsumoCamarones_Editar_BodNacional.retornarCantidadTotalConsumo(listadoConsumo.get(i).getId());
                registro[6]=""+listadoConsumo.get(i).getValorTotalEnPesos();
                registro[7]=""+listadoConsumo.get(i).getNombreQuienElabora();
                registro[8]=""+listadoConsumo.get(i).getEstado();
    ...
    public void buscarCP(){
        try{                                         
            ...
            ControlDB_VentaFacturacionComputador_EditarFacturaNacional controlDB_Ventas= new ControlDB_VentaFacturacionComputador_EditarFacturaNacional();
