...
import Controladores.ControlDB_VentaFacturacionElectronica_EditarFacturaExtranjera;
...
public class VentaFacturacionElectronica_Editar_BodExtranjera extends javax.swing.JPanel {
    String accion="";
    Usuario user;
    ...
    public VentaFacturacionElectronica_Editar_BodExtranjera(Usuario u) {
        user= u;
        initComponents();
    ...
    private void initComponents() {
        ...
        RegistrarVentaExtranjera1.setText("BUSCAR FACTURAS ELECTRONICAS EXTRANJERAS");
    ...
    private void CargarClienteMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_CargarClienteMouseClicked
        if(FacturaVentaNo.getText().equals("Factura de Venta No.")){
            JOptionPane.showMessageDialog(null, "No se ha cargado factura de venta Electronica Extranjera para editar");
        }else{
                                                    ...
                                                    if(validarQueCargueAlmenosUnCP()){//Validamos que se cargue al menos un CP, para poder Registrar la Venta.
                                                        ...
                                                        if(validarEnCPCargadosCantidadAVenderSeaMayorACero()){//Validamos que las cantidades de los CP sea mayor a cero
                                                            ...
                                                            try {
                                                                ...
                                                                Logger.getLogger(VentaFacturacionElectronica_Editar_BodExtranjera.class.getName()).log(Level.SEVERE, null, ex);
                                                            }
                                                            ...
                                                            ControlDB_VentaFacturacionElectronica_EditarFacturaExtranjera controlDB_VentasEditar = new ControlDB_VentaFacturacionElectronica_EditarFacturaExtranjera();
                                                            try {
                                                                if(controlDB_VentasEditar.validorCantidadesExistentesBodegaExtranjera(ArrayItemFacturaEditar)){
                                                                    ...
                                                                    if(valorW==1){
                                                                        ...
                                                                        generarReportes.generar_FacturaVentaElectronicaExtranjera(facturaVenta.getId());
        ...
        try{
            ...
            if(fila1==-1){
                ...
                try{
                    ...
                    ControlDB_VentaFacturacionElectronica_EditarFacturaExtranjera controlDB_Ventas_Editar_Factura_BodExtranjera = new ControlDB_VentaFacturacionElectronica_EditarFacturaExtranjera();
    ...
    public void BuscarEnVentanaInternaDocumentos(String valorConsulta) throws SQLException{               
        ...
        ControlDB_VentaFacturacionElectronica_EditarFacturaExtranjera controlDB_Ventas_Editar_Factura_BodExtranjera = null;
        if(valorConsulta.equals("")){
             controlDB_Ventas_Editar_Factura_BodExtranjera = new ControlDB_VentaFacturacionElectronica_EditarFacturaExtranjera();
    ...
    public void buscarCP(){
        try{                                         
            ...
            ControlDB_VentaFacturacionElectronica_EditarFacturaExtranjera controlDB_Ventas= new ControlDB_VentaFacturacionElectronica_EditarFacturaExtranjera();
