...
import Controladores.ControlDB_PermisoMenu;
...
public class Permiso_Menu extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel7.setText("ACTUALIZAR PERMISOS EN MENÚ");
    ...
    private void Btn_buscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Btn_buscarActionPerformed
        ...
        try {
            ...
            Logger.getLogger(Permiso_Menu.class.getName()).log(Level.SEVERE, null, ex);
        }
        ...
        try{
            ...
            if(fila1==-1){
               JOptionPane.showMessageDialog(null,"no se ha seleccionando ninguna fila");
                ...
                PermisoMenu uni = new PermisoMenu();
            ...
            if(descripcionA.getText().equalsIgnoreCase("")){
                ...
                try{
                    ...
                    if(codigoA.equals("")){
                        ...
                        ControlDB_PermisoMenu controlControlDB_PermisoMenu = new ControlDB_PermisoMenu();
                        int retorno = controlControlDB_PermisoMenu.actualizarPermisoMenu(u);
                        if(retorno ==1){
 ...
 public void tabla(String valorConsulta) throws SQLException{
        ...
        ControlDB_PermisoMenu controlDB_PermisoMenu = new ControlDB_PermisoMenu();
        ControlDB_Otros controlOtros = new ControlDB_Otros();
        ArrayList<PermisoMenu> listadoPermisoMenu=controlDB_PermisoMenu.buscarPermisoMenu(valorConsulta);
        for(int i =0; i< listadoPermisoMenu.size(); i++){
            registro[0]=""+listadoPermisoMenu.get(i).getId();
            registro[1]=""+listadoPermisoMenu.get(i).getDescripcion();
            registro[2]=""+controlOtros.convertidorEstadoID_x_Nombre(listadoPermisoMenu.get(i).getEstado());
            modelo.addRow(registro);
            Table1.setModel(modelo);
        } 
    }
    public void consultarParaActualizar (PermisoMenu permisoMenu) throws SQLException{
        ControlDB_PermisoMenu controlPermisoMenu = new ControlDB_PermisoMenu();
        ControlDB_Otros  controlOtros = new ControlDB_Otros();
        ArrayList<PermisoMenu> listadoPermisoMenu = controlPermisoMenu.consultarUnicoPermisoMenu(permisoMenu);
        for(int i =0; i< listadoPermisoMenu.size(); i++){      
            codigoA.setText(""+listadoPermisoMenu.get(i).getId());
            descripcionA.setText(""+listadoPermisoMenu.get(i).getDescripcion());
            estadoA.setSelectedItem(controlOtros.convertidorEstadoID_x_Nombre(listadoPermisoMenu.get(i).getEstado()));    
        } 
    }
}
