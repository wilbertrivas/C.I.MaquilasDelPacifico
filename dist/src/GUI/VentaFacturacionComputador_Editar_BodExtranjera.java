...
public class VentaFacturacionComputador_Editar_BodExtranjera extends javax.swing.JPanel {
    String accion="";
    Usuario user;
    ...
    public VentaFacturacionComputador_Editar_BodExtranjera(Usuario u) {
        user= u;
        initComponents();
    ...
    private void initComponents() {
        ...
        tabla_ListadoBusquedaClientes.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tabla_ListadoBusquedaClientesMouseClicked(evt);
            }
        });
        ...
        RegistrarVentaExtranjera1.setText("BUSCAR FACTURAS A COMPUTADOR EXTRANJERAS");
        ...
        add(RegistrarVentaExtranjera1, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 20, 430, -1));
                                                ...
                                                try{
                                                    ...
                                                    if(validarQueCargueAlmenosUnCP()){//Validamos que se cargue al menos un CP, para poder Registrar la Venta.
                                                        ...
                                                        if(validarEnCPCargadosCantidadAVenderSeaMayorACero()){//Validamos que las cantidades de los CP sea mayor a cero
                                                            ...
                                                            ControlDB_VentaFacturacionComputador_EditarFacturaExtranjera controlDB_VentasEditar = new ControlDB_VentaFacturacionComputador_EditarFacturaExtranjera();
                                                            try {
                                                                if(controlDB_VentasEditar.validorCantidadesExistentesBodegaExtranjera(ArrayItemFacturaEditar)){
                                                                    ...
                                                                    if(valorW==1){
                                                                        ...
                                                                        generarReportes.generar_FacturaVentaComputadorExtranjera(facturaVenta.getId());
            ...
            try{
                ...
                if(fila1==-1){
                    ...
                    try{
                        ...
                        ControlDB_VentaFacturacionComputador_EditarFacturaExtranjera controlDB_Ventas_Editar_Factura_BodExtranjera = new ControlDB_VentaFacturacionComputador_EditarFacturaExtranjera();
    ...
    private void tabla_ListadoBusquedaClientesMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabla_ListadoBusquedaClientesMouseClicked
        if (evt.getClickCount() == 2) {
            DefaultTableModel modelo;
            int fila1;
            try{
    ...
    }//GEN-LAST:event_tabla_ListadoBusquedaClientesMouseClicked
    ...
    public void BuscarEnVentanaInternaDocumentos(String valorConsulta) throws SQLException{               
        ...
        ControlDB_VentaFacturacionComputador_EditarFacturaExtranjera controlDB_Ventas_Editar_Factura_BodExtranjera = null;
        if(valorConsulta.equals("")){
             controlDB_Ventas_Editar_Factura_BodExtranjera = new ControlDB_VentaFacturacionComputador_EditarFacturaExtranjera();
    ...
    public void buscarCP(){
        try{                                         
            ...
            ControlDB_VentaFacturacionComputador_EditarFacturaExtranjera controlDB_Ventas= new ControlDB_VentaFacturacionComputador_EditarFacturaExtranjera();
