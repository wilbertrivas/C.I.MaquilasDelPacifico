...
public class VentaFacturacionComputador_Consultar extends javax.swing.JPanel {
    ...
    String [] registro;  
    public VentaFacturacionComputador_Consultar() throws SQLException {
        initComponents();  
    ...
    private void consultarVentasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_consultarVentasActionPerformed
        ...
        if(validarConsulta){
            try {
                ...
                Logger.getLogger(VentaFacturacionComputador_Consultar.class.getName()).log(Level.SEVERE, null, ex);
                    ...
                    if(Bodega.equals("Extranjera")){
                        if(valorFacturacion.getSelectedItem().toString().equalsIgnoreCase("DOLARES")){
                            if(estado.equals("Activo")){
                                ...
                                generarReportes.generar_FacturaVentaComputadorExtranjera(Integer.parseInt(id));
                            }else{
                                if(estado.equals("Anulada")){
                                    Generar_Reportes generarReportes = new Generar_Reportes();
                                    generarReportes.generar_FacturaVentaComputadorExtranjeraAnulada(Integer.parseInt(id));
                                }
                            }
                        }else{
                            if(valorFacturacion.getSelectedItem().toString().equalsIgnoreCase("PESOS")){
                                if(estado.equals("Activo")){
                                    Generar_Reportes generarReportes = new Generar_Reportes();
                                    generarReportes.generar_FacturaVentaComputadorExtranjera_Pesos(Integer.parseInt(id));
                                }else{
                                    if(estado.equals("Anulada")){
                                        Generar_Reportes generarReportes = new Generar_Reportes();
                                        generarReportes.generar_FacturaVentaComputadorExtranjeraAnulada_Pesos(Integer.parseInt(id));
                                    }
                                }
                            }
                        }
                        ...
                        if(Bodega.equals("Nacional")){
                            if(estado.equals("Activo")){
                                Generar_Reportes generarReportes = new Generar_Reportes();
                                generarReportes.generar_FacturaVentaComputadorNacional(Integer.parseInt(id));
                            }else{
                                if(estado.equals("Anulada")){
                                    Generar_Reportes generarReportes = new Generar_Reportes();
                                    generarReportes.generar_FacturaVentaComputadorNacionalAnulada(Integer.parseInt(id));
                                }
                            }
                        }
                    }
