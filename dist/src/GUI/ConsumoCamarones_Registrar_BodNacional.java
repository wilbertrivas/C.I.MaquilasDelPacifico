...
public class ConsumoCamarones_Registrar_BodNacional extends javax.swing.JPanel {
    String valor="";
    String accion="";
    Usuario user;
    ...
    public ConsumoCamarones_Registrar_BodNacional(Usuario u) {
        user= u;
        initComponents();
        ...
        //#########################################################
        ControlDB_ConsumoCamaronesNacional controlDB_ConsumoNacional = new ControlDB_ConsumoCamaronesNacional();
        try{
            consumoNumero=controlDB_ConsumoNacional.retornarElMaximo();
            consumoNumero++;
    ...
    private void initComponents() {
        ...
        add(VentanaInternaVentas, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 70, 1120, 410));

        cli_celular.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        cli_celular.setForeground(new java.awt.Color(102, 102, 102));
        add(cli_celular, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 110, 270, 20));

        jLabel9.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel9.setForeground(new java.awt.Color(0, 102, 102));
        jLabel9.setText("REGISTRAR CONSUMO DE CAMARONES");
        ...
        add(alertaDatosFactura, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 260, 1150, 30));
        ...
        add(cli_nit, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 30, 360, 20));
        ...
        add(fechaFactura, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 150, 250, 30));
        ...
        add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 190, 410, 70));

        jLabel27.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel27.setText("Dirección:");
        add(jLabel27, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 30, 70, 20));

        cli_direccion.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        cli_direccion.setForeground(new java.awt.Color(102, 102, 102));
        add(cli_direccion, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 30, 460, 20));

        jLabel31.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel31.setText("Correo:");
        add(jLabel31, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 50, 70, 20));

        cli_correo.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        cli_correo.setForeground(new java.awt.Color(102, 102, 102));
        add(cli_correo, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 50, 460, 20));

        jLabel32.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel32.setText("Ciudad:");
        add(jLabel32, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 70, 50, 20));

        cli_ciudad.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        cli_ciudad.setForeground(new java.awt.Color(102, 102, 102));
        add(cli_ciudad, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 70, 460, 20));
        ...
        add(cli_nombre, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 70, 360, 20));

        cli_telefono.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        cli_telefono.setForeground(new java.awt.Color(102, 102, 102));
        add(cli_telefono, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 90, 360, 20));

        jLabel12.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel12.setText("Factura:");
        add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 150, 70, 30));

        jLabel36.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel36.setForeground(new java.awt.Color(102, 102, 102));
        jLabel36.setText("NACIONAL");
        add(jLabel36, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 150, 200, 30));

        jLabel38.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel38.setText("Bodega:");
        add(jLabel38, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 150, 110, 30));
        ...
        add(jScrollPane4, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 290, 1130, 170));
        ...
        add(RegistrarConsumo, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 490, 240, 60));
        ...
        add(precioVentaKilo, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 190, 200, 30));
        ...
        add(alertaEmpresaLocal, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 90, 770, 30));
        ...
        add(jLabel15, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 20, 1050, 130));
                            ...
                            if(validarQueCargueAlmenosUnCP()){//Validamos que se cargue al menos un CP, para poder Registrar el Consumo.
                                ...
                                if(validarEnCPCargadosCantidadAVenderSeaMayorACero()){
                                    ...
                                    try {
                                        ...
                                        Logger.getLogger(ConsumoCamarones_Registrar_BodNacional.class.getName()).log(Level.SEVERE, null, ex);
                                    }
                                    ...
                                    try {
                                        if(controlDB_ConsumoNacional.validorCantidadesExistentesBodegaNacional(ArrayItemConsumo)){
                                            ...
                                            if(valorW==1){
                                                ...
                                                consumoNumero++;
                                                ConsumoNo.setText("Consumo No.  "+consumoNumero);                                    
                                                ControlDB_ConsumoCamaronesNacional controlDB_ConsumoCamaronesNacional = new ControlDB_ConsumoCamaronesNacional();
                                                Generar_Reportes generarReportes = new Generar_Reportes();
                                                generarReportes.generar_ConsumoCamarones(controlDB_ConsumoCamaronesNacional.retornarElMaximo());
                                                //Generar_Reportes generarReportes = new Generar_Reportes();
    ...
    public void BuscarEnVentanaInterna() throws SQLException{
       switch(valor){
            ...
            case "CP":{
                ...
                modelo = new DefaultTableModel(null, titulo);
                ControlDB_ConsumoCamaronesNacional controlDB_ConsumoCamaronesNacional= new ControlDB_ConsumoCamaronesNacional();
                ArrayList<IngresoProducto> listadoCp=controlDB_ConsumoCamaronesNacional.consultarCpBodegaNacional(codigo.getText());
                for(int i =0; i< listadoCp.size(); i++){
                    registro[0]=""+listadoCp.get(i).getCp();
                    registro[1]=""+controlDB_ConsumoCamaronesNacional.validarNombreProducto(listadoCp.get(i).getProducto_id()).getDescripcion();
                    registro[2]=""+controlDB_ConsumoCamaronesNacional.validarNombreBodegaNacional(""+listadoCp.get(i).getBodega_ingresoProductoInicial());
                    registro[3]=""+listadoCp.get(i).getCantidadInicial();
                    registro[4]=""+controlDB_ConsumoCamaronesNacional.validarSaldoBodegaNacional(listadoCp.get(i).getId());
