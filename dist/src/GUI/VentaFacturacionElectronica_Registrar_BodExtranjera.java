...
public class VentaFacturacionElectronica_Registrar_BodExtranjera extends javax.swing.JPanel {
    String valor="";
    String accion="";
    Usuario user;
    ...
    public VentaFacturacionElectronica_Registrar_BodExtranjera(Usuario u) {
        user= u;
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel9.setText("REGISTRO DE FACTURA ELECTRONICA  EXTRANJERA");
        add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 0, 560, -1));
                                                    ...
                                                    if(validarQueCargueAlmenosUnCP()){//Validamos que se cargue al menos un CP, para poder Registrar la Venta.
                                                        ...
                                                        if(validarEnCPCargadosCantidadAVenderSeaMayorACero()){
                                                            ...
                                                            try {
                                                                ...
                                                                Logger.getLogger(VentaFacturacionElectronica_Registrar_BodExtranjera.class.getName()).log(Level.SEVERE, null, ex);
                                                            }
                                                            ...
                                                            try {
                                                                if(controlDB_Ventas.validorCantidadesExistentesBodegaExtranjera(ArrayItemFactura)){
                                                                    ...
                                                                    if(valorW==1){
                                                                        ...
                                                                        generarReportes.generar_FacturaVentaElectronicaExtranjera(controlDB_Ventas.retornarElMaximo());
                                                                        ...
                                                                        JOptionPane.showMessageDialog(null, "Error al registrar la Venta Eléctronica");    
                                                                    }
                                                                }else{
                                                                    JOptionPane.showMessageDialog(null, "Error!!. No se puede Registrar la Venta Eléctronica Verifique nuevamente todos los saldos en bodega debido a que han cambiado. Sugerencia Elimine los CP y vuelva a cargarlos");
                                                                }
