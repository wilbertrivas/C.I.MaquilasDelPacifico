...
public class Compra_Editar extends javax.swing.JPanel {
   ...
   // Controladores.ControladorDB_old ControlDB = new ControladorDB_old();
    ...
    private void initComponents() {
        ...
        ventanaInterna_Nombre1.setText("Ingrese Número de Factura de Compra");
        ...
        add(fechaResolución, new org.netbeans.lib.awtextra.AbsoluteConstraints(660, 220, 280, 20));
                    ...
                    try{
                        ...
                        try{
                            ...
                            if(prov != null){
                                ...
                                fechaResolución.setText(""+prov.getFechaResolucion()); 
                            }
