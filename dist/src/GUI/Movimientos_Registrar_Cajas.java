...
import Controladores.ControlDB_ConsumoCamaronesNacional;
...
public class Movimientos_Registrar_Cajas extends javax.swing.JPanel {
    String valor="";
    String accion="";
    Usuario user;
    ...
    public Movimientos_Registrar_Cajas(Usuario u) {
        user= u;
        initComponents();
    ...
    private void initComponents() {
        ...
        add(VentanaInternaVentas, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 50, 1100, 400));

        jLabel9.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel9.setForeground(new java.awt.Color(0, 102, 102));
        jLabel9.setText("MOVIMIENTO DE CAJAS EN BODEGA");
        ...
        add(jLabel20, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 130, 80, 30));
        ...
        add(Label_CargarCP, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 70, 70, 70));
        ...
        add(jScrollPane4, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 190, 1090, 100));
        ...
        add(RegistrarMovimiento, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 300, 240, 60));

        MovimientoNo.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        MovimientoNo.setText("Movimiento No.");
        add(MovimientoNo, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 30, 260, 20));

        jLabel5.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel5.setText("FECHA DE MOVIMIENTO");
        add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 130, 160, 30));
        ...
        add(fechaMovimiento, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 130, 160, 30));
        ...
        add(alertaFechaMovimiento, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 160, 1090, 30));
    ...
    private void RegistrarMovimientoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RegistrarMovimientoActionPerformed
        try{
            ...
            if(filas <= 0){
                ...
                ControlDB_Movimientos_Cajas  controlDB_Movimientos = new ControlDB_Movimientos_Cajas();
                if(controlDB_Movimientos.validarSaldosBodegasMovimientos(CP,saldoBodegaExtranjeraActual,saldoBodegaNacionalActual)){
                    int result= controlDB_Movimientos.registrarMovimiento( fechaMovimiento, CP, saldoBodegaExtranjeraModificado, saldoBodegaNacionalModificado,user, saldoExtranjeraTraslado, saldoNacionalTrasladado,saldoBodegaExtranjeraActual, saldoBodegaNacionalActual);
                    if(result ==6){
                        ...
                        ControlDB_Movimientos_Cajas controlDB_MovimientosT = new ControlDB_Movimientos_Cajas();
