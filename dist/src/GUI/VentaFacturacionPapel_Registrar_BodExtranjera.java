...
public class VentaFacturacionPapel_Registrar_BodExtranjera extends javax.swing.JPanel {
    String valor="";
    String accion="";
    Usuario user;
    ...
    public VentaFacturacionPapel_Registrar_BodExtranjera(Usuario u) {
        user= u;
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel9.setText("REGISTRO DE FACTURA A PAPEL  EXTRANJERA");
                                                    ...
                                                    if(validarQueCargueAlmenosUnCP()){//Validamos que se cargue al menos un CP, para poder Registrar la Venta.
                                                        ...
                                                        if(validarEnCPCargadosCantidadAVenderSeaMayorACero()){
                                                            ...
                                                            try {
                                                                ...
                                                                Logger.getLogger(VentaFacturacionPapel_Registrar_BodExtranjera.class.getName()).log(Level.SEVERE, null, ex);
                                                            }
                                                            ...
                                                            try {
                                                                if(controlDB_Ventas.validorCantidadesExistentesBodegaExtranjera(ArrayItemFactura)){
                                                                    ...
                                                                    if(valorW==1){
                                                                        ...
                                                                        generarReportes.generar_FacturaVentaPapelExtranjera(controlDB_Ventas.retornarElMaximo());
