...
public class Cliente_Registrar extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        registrarCliente.setFont(new java.awt.Font("Tahoma", 1, 10)); // NOI18N
        registrarCliente.setIcon(new javax.swing.ImageIcon(getClass().getResource("/GUI/Img/Bodega_Registrar_Bton_Registrar.PNG"))); // NOI18N
        ...
        add(registrarCliente, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 420, 140, -1));

        jLabel5.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel5.setText("TIPO CLIENTE:");
        add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 50, 100, 20));

        add(tipoCliente, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 40, 330, 40));
        ...
        add(nombre, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 90, 330, 30));
        ...
        jLabel4.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "FORMULARIO REGISTRO DE CLIENTES", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 14))); // NOI18N
        add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 20, 840, 20));
            ...
            if(!personaNatural.isSelected()){ //Persona Natural no fue seleccionado debe validar el Nombre del Cliente
                if(nombre.getText().equals("")){
                    ...
                    try{
                        ...
                        cliente.setDigitoVerificacion(digitoVerificacion.getText());
                        cliente.setNombre(nombre.getText());
                        cliente.setTipoCliente_id(controladorTipoCliente.validarTipoCliente_ID_por_Nombre(tipoCliente.getSelectedItem().toString()));
                        ...
                        cliente.setObservacion(observacion.getText());
                        ControlDB_Otros validador = new ControlDB_Otros();
                        cliente.setEstado(validador.convertidorValorEstado(estado.getSelectedIndex()));
                         //buscamos por Nit si ya la empresa Existe y de ser así consultamos la ultima sucursal
                        cliente.setSucursal(controladorCliente.consultarConsecutivoSucursal(cliente));
                        if(cliente.getSucursal()!=1){//Ya existe un Cliente creado con ese Nit por tal motivo procedemos a crear una sucursal
                            int confirmacion = JOptionPane.showConfirmDialog(null, "Ya existe Clientes creado con ese Nit por tal motivo se procede la sucursal No. "+cliente.getSucursal());
                            //Si == 0,  No == 1, Cancelar == 2
                            if(confirmacion == 0){//Procedemos a registrar la nueva sucursal
                                int result=0;
                                result=controladorCliente.registrarCliente(cliente);
                    ...
                    if(PersonaNatural_apellidos.getText().equals("")){
                        ...
                        if(PersonaNatural_nombres.getText().equals("")){
                            ...
                            try{
                                ...
                                cliente.setNit(nit.getText());
                                cliente.setDigitoVerificacion(digitoVerificacion.getText());
                                cliente.setNombre(""+PersonaNatural_apellidos.getText()+" "+PersonaNatural_nombres.getText());
                                cliente.setTipoCliente_id(controladorTipoCliente.validarTipoCliente_ID_por_Nombre(tipoCliente.getSelectedItem().toString()));
                                cliente.setTelefono(telefono.getText());
                                cliente.setCelular(celular.getText());
                                cliente.setDireccion(direccion.getText());
                                ...
                                cliente.setEstado(validador.convertidorValorEstado(estado.getSelectedIndex()));
                                 //buscamos por Nit si ya la empresa Existe y de ser así consultamos la ultima sucursal
                                cliente.setSucursal(controladorCliente.consultarConsecutivoSucursal(cliente));
                                //JOptionPane.showMessageDialog(null, ""+cliente.getSucursal());
                                if(cliente.getSucursal()!=1){//Ya existe un Cliente creado con ese Nit por tal motivo procedemos a crear una sucursal
                                    int confirmacion = JOptionPane.showConfirmDialog(null, "Ya existe Clientes creado con ese Nit por tal motivo se procede a crear la sucursal No. "+cliente.getSucursal());
                                    //Si == 0,  No == 1, Cancelar == 2
                                    if(confirmacion == 0){//Procedemos a registrar la nueva sucursal
                                        int result=0;
                                        result=controladorCliente.registrarCliente(cliente);
