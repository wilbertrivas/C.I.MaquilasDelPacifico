...
import Controladores.ControlDB_ConsumoCajas_Editar_BodNacional;
...
public class ConsumoCajas_Editar_BodNacional extends javax.swing.JPanel {
    String accion="";
    Usuario user;
    ...
    public ConsumoCajas_Editar_BodNacional(Usuario u) {
        user= u;
        initComponents();
    ...
    private void initComponents() {
        ...
        add(RegistrarVentaExtranjera, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 530, 240, 60));
        ...
        add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 530, 190, 60));
        ...
        add(fechaConsumo, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 220, 270, 30));

        jLabel19.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel19.setText("Observación:");
        add(jLabel19, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 260, 90, 30));
        ...
        add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 230, 160, 20));

        jLabel36.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel36.setForeground(new java.awt.Color(102, 102, 102));
        jLabel36.setText("NACIONAL");
        add(jLabel36, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 220, 190, 30));
                            ...
                            if(validarQueCargueAlmenosUnCP()){//Validamos que se cargue al menos un CP, para poder Registrar la Venta.
                                ...
                                if(validarEnCPCargadosCantidadAVenderSeaMayorACero()){//Validamos que las cantidades de los CP sea mayor a cero
                                    ...
                                    try {
                                        ...
                                        Logger.getLogger(ConsumoCajas_Editar_BodNacional.class.getName()).log(Level.SEVERE, null, ex);
                                    }
                                    ...
                                    //facturaVenta.setValorTotalEnDolarCalculados(new BigDecimal("0"));
                                    ControlDB_ConsumoCajas_Editar_BodNacional controlDB_ConsumoEditar = new ControlDB_ConsumoCajas_Editar_BodNacional();
                                    try {
        ...
        try{
            ...
            if(fila1==-1){
                ...
                try{
                    ...
                    ControlDB_ConsumoCajas_Editar_BodNacional controlDB_ConsumoCajas_Editar_BodNacional = new ControlDB_ConsumoCajas_Editar_BodNacional();
                    Consumo consumo =null;
                    ArrayList<ItemConsumo> listadoItemConsumo = null;    
                    Cliente cliente =null;
                    try{
                        consumo=controlDB_ConsumoCajas_Editar_BodNacional.consultarUnicoConsumoNacional(idConsumo);
                        //System.out.println(""+consumo.getId()+":"+consumo.getNombreQuienElabora());
                        listadoItemConsumo=controlDB_ConsumoCajas_Editar_BodNacional.consultarItemConsumoNacional(idConsumo);
                        ...
                        cliente= controlDB_ConsumoCajas_Editar_BodNacional.retornarCliente(c);
                        ...
                        for(int i =0; i< listadoItemConsumo.size(); i++){ 
                           ...
                           IngresoProducto ingresoProducto= controlDB_ConsumoCajas_Editar_BodNacional.retornarCompra(listadoItemConsumo.get(i).getIdIngresoProducto());
                            //registroCPX[0]=listadoItemFacturas.get(i).getIdIngresoProducto());
                            registroCPX[0]=ingresoProducto.getCp();
                            
                            registroCPX[1]=controlDB_ConsumoCajas_Editar_BodNacional.retornoNombreProducto(ingresoProducto.getProducto_id());
                            ...
                            proveedor= controlDB_ConsumoCajas_Editar_BodNacional.retornarProveedor(p);
                            ...
                            cantidadEnBodega = cantidadEnBodega+ Integer.parseInt(controlDB_ConsumoCajas_Editar_BodNacional.validarSaldoBodegaNacional(""+listadoItemConsumo.get(i).getIdIngresoProducto()));
    ...
    public void BuscarEnVentanaInternaDocumentos(String valorConsulta) throws SQLException{               
        ...
        ControlDB_ConsumoCajas_Editar_BodNacional controlDB_ConsumoCajas_Editar_BodNacional = null;
        if(valorConsulta.equals("")){
             controlDB_ConsumoCajas_Editar_BodNacional = new ControlDB_ConsumoCajas_Editar_BodNacional();
            listadoConsumo=controlDB_ConsumoCajas_Editar_BodNacional.consultarConsumosCajasNacional(codigoDocumento.getText());
        }else{
            try{
                Integer.parseInt(codigoDocumento.getText());
                controlDB_ConsumoCajas_Editar_BodNacional = new ControlDB_ConsumoCajas_Editar_BodNacional();
                listadoConsumo=controlDB_ConsumoCajas_Editar_BodNacional.consultarConsumosCajasNacional(" AND [consumo].[id]='"+codigoDocumento.getText()+"'");
            }catch(Exception e){
        ...
        if(listadoConsumo !=null){
            for(int i =0; i< listadoConsumo.size(); i++){ 
                ...
                registro[4]=""+controlDB_ConsumoCajas_Editar_BodNacional.consultarNombreCliente(c);    
                registro[5]=""+controlDB_ConsumoCajas_Editar_BodNacional.retornarCantidadTotalConsumo(listadoConsumo.get(i).getId());
