...
import Controladores.ControlDB_VentaFacturacionElectronica_ModificarDex;
...
public class VentaFacturacionElectronica_ModificarDEX extends javax.swing.JPanel {
    ...
    String [] registro;  
    public VentaFacturacionElectronica_ModificarDEX() throws SQLException {
        initComponents();  
    ...
    private void initComponents() {
        ...
        jLabel8.setText("CONSULTA DE VENTAS ELECTRÓNICA");
    ...
    private void consultarVentasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_consultarVentasActionPerformed
        ...
        if(idVenta.isSelected()){
            if(editIdVenta.getText().equals("")){
                alertaGeneral.setText("Mensaje: El Código de Factura de Venta Electrónica no puede estar Vacio");
        ...
        if(validarConsulta){
            try {
                ...
                Logger.getLogger(VentaFacturacionElectronica_ModificarDEX.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void buscar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buscar1ActionPerformed
        ...
        ControlDB_VentaFacturacionElectronica_ModificarDex controlDB_VentasModificarDex = new ControlDB_VentaFacturacionElectronica_ModificarDex();
        try {
            int result= controlDB_VentasModificarDex.modificarDex(idFactura, DexNuevo);
            if(result == 1){
                JOptionPane.showMessageDialog(null, "La factura Electrónica No."+idFactura+ " Se ha le ha modificador el DEX con exito");
            ...
            JOptionPane.showMessageDialog(null, "La factura Electrónica No."+idFactura+ " No se ha le ha modificador el DEX, verifique información");
            Logger.getLogger(VentaFacturacionElectronica_ModificarDEX.class.getName()).log(Level.SEVERE, null, ex);
        }
