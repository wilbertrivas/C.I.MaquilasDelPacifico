...
import Controladores.ControlDB_VentaFacturacionPapel_RegistrarFacturaExtranjera;
import Controladores.ControlDB_VentaFacturacionPapel_RegistrarFacturaNacional;
...
public class VentaFacturacionPapel_Registrar_BodNacional extends javax.swing.JPanel {
    String valor="";
    String accion="";
    Usuario user;
    ...
    public VentaFacturacionPapel_Registrar_BodNacional(Usuario u) {
        user= u;
        initComponents();
        ...
        //#########################################################
        ControlDB_VentaFacturacionPapel_RegistrarFacturaExtranjera controlDB_Ventas = new ControlDB_VentaFacturacionPapel_RegistrarFacturaExtranjera();
        try{
                            ...
                            if(validarQueCargueAlmenosUnCP()){//Validamos que se cargue al menos un CP, para poder Registrar la Venta.
                                ...
                                if(validarEnCPCargadosCantidadAVenderSeaMayorACero()){
                                    ...
                                    try {
                                        ...
                                        Logger.getLogger(VentaFacturacionPapel_Registrar_BodNacional.class.getName()).log(Level.SEVERE, null, ex);
                                    }
                                    ...
                                    ControlDB_VentaFacturacionPapel_RegistrarFacturaNacional controlDB_Ventas = new ControlDB_VentaFacturacionPapel_RegistrarFacturaNacional();
                                    try {
                                        if(controlDB_Ventas.validorCantidadesExistentesBodegaNacional(ArrayItemFactura)){
                                            ...
                                            if(valorW==1){
                                                ...
                                                generarReportes.generar_FacturaVentaPapelNacional(controlDB_Ventas.retornarElMaximo());
