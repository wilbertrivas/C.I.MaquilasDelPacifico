...
import Controladores.ControlDB_VentaFacturacionPapel_EditarFacturaNacional;
...
public class VentaFacturacionPapel_Editar_BodNacional extends javax.swing.JPanel {
    String accion="";
    Usuario user;
    ...
    public VentaFacturacionPapel_Editar_BodNacional(Usuario u) {
        user= u;
        initComponents();
    ...
    private void initComponents() {
        ...
        RegistrarVentaExtranjera1.setText("BUSCAR FACTURAS A PAPEL NACIONALES");
    ...
    private void CargarClienteMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_CargarClienteMouseClicked
        if(FacturaVentaNo.getText().equals("Factura de Venta No.")){
            JOptionPane.showMessageDialog(null, "No se ha cargado factura de venta a Papel Nacional para editar");
        }else{
                            ...
                            if(validarQueCargueAlmenosUnCP()){//Validamos que se cargue al menos un CP, para poder Registrar la Venta.
                                ...
                                if(validarEnCPCargadosCantidadAVenderSeaMayorACero()){//Validamos que las cantidades de los CP sea mayor a cero
                                    ...
                                    try {
                                        ...
                                        Logger.getLogger(VentaFacturacionPapel_Editar_BodNacional.class.getName()).log(Level.SEVERE, null, ex);
                                    }
                                    ...
                                    facturaVenta.setValorTotalEnDolarCalculados(new BigDecimal("0"));
                                    ControlDB_VentaFacturacionPapel_EditarFacturaNacional controlDB_VentasEditar = new ControlDB_VentaFacturacionPapel_EditarFacturaNacional();
                                    try {
                                        if(controlDB_VentasEditar.validorCantidadesExistentesBodegaNacional(ArrayItemFacturaEditar)){
                                            ...
                                            if(valorW==1){
                                                ...
                                                generarReportes.generar_FacturaVentaPapelNacional(facturaVenta.getId());
        ...
        try{
            ...
            if(fila1==-1){
                ...
                try{
                    ...
                    ControlDB_VentaFacturacionPapel_EditarFacturaNacional controlDB_Ventas_Editar_Factura_BodNacional = new ControlDB_VentaFacturacionPapel_EditarFacturaNacional();
    ...
    public void BuscarEnVentanaInternaDocumentos(String valorConsulta) throws SQLException{               
        ...
        ControlDB_VentaFacturacionPapel_EditarFacturaNacional controlDB_Ventas_Editar_Factura_BodNacional = null;
        if(valorConsulta.equals("")){
             controlDB_Ventas_Editar_Factura_BodNacional = new ControlDB_VentaFacturacionPapel_EditarFacturaNacional();
    ...
    public void buscarCP(){
        try{                                         
            ...
            ControlDB_VentaFacturacionPapel_EditarFacturaNacional controlDB_Ventas= new ControlDB_VentaFacturacionPapel_EditarFacturaNacional();
