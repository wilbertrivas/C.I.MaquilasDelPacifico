...
import Controladores.ControlDB_VentaFacturacionComputador_RegistrarFacturaNacional;
...
public class VentaFacturacionComputador_Registrar_BodNacional extends javax.swing.JPanel {
    String valor="";
    String accion="";
    Usuario user;
    ...
    public VentaFacturacionComputador_Registrar_BodNacional(Usuario u) {
        user= u;
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel9.setText("REGISTRO DE VENTA A COMPUTADOR NACIONAL");
        add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 0, 470, 30));
                            ...
                            if(validarQueCargueAlmenosUnCP()){//Validamos que se cargue al menos un CP, para poder Registrar la Venta.
                                ...
                                if(validarEnCPCargadosCantidadAVenderSeaMayorACero()){
                                    ...
                                    try {
                                        ...
                                        Logger.getLogger(VentaFacturacionComputador_Registrar_BodNacional.class.getName()).log(Level.SEVERE, null, ex);
                                    }
                                    ...
                                    ControlDB_VentaFacturacionComputador_RegistrarFacturaNacional controlDB_Ventas = new ControlDB_VentaFacturacionComputador_RegistrarFacturaNacional();
                                    try {
                                        if(controlDB_Ventas.validorCantidadesExistentesBodegaNacional(ArrayItemFactura)){
                                            ...
                                            if(valorW==1){
                                                ...
                                                generarReportes.generar_FacturaVentaComputadorNacional(controlDB_Ventas.retornarElMaximo());
