...
//import Controladores.ControlDB_VentasExtranjera;
import Controladores.ControlDB_VentaFacturacionPapel_EditarFacturaExtranjera;
...
public class VentaFacturacionPapel_Editar_BodExtranjera extends javax.swing.JPanel {
    String accion="";
    Usuario user;
    ...
    public VentaFacturacionPapel_Editar_BodExtranjera(Usuario u) {
        user= u;
        initComponents();
        ...
        /*//#########################################################
        ControlDB_VentasExtranjera controlDB_Ventas = new ControlDB_VentasExtranjera();
        try{
    ...
    private void initComponents() {
        ...
        add(alertaDatosFactura, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 410, 1010, 30));

        label_CargarCliente.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        label_CargarCliente.setText("IMPORTADOR");
        ...
        add(label_CargarCP, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 490, 80, 30));
        ...
        add(fechaFactura, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 220, 220, 30));
        ...
        add(trm, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 260, 220, 30));

        jLabel19.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel19.setText("Observación:");
        add(jLabel19, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 350, 120, 30));

        jLabel28.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel28.setText("Trm:");
        add(jLabel28, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 260, 70, 30));
        ...
        add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 340, 490, 70));
        ...
        add(dex, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 260, 170, 30));
        ...
        add(valorTotalDolar, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 300, 220, 30));

        jLabel36.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel36.setForeground(new java.awt.Color(102, 102, 102));
        jLabel36.setText("EXTRANJERA");
        add(jLabel36, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 220, 170, 30));

        jLabel37.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel37.setText("en dolar:");
        add(jLabel37, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 310, 80, 20));
        ...
        add(label_CargarCP2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 430, 70, 70));

        jLabel22.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel22.setText("Dex:");
        add(jLabel22, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 260, 80, 30));
        ...
        add(jScrollPane4, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 440, 1010, 150));

        jLabel39.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel39.setText("Valor total");
        add(jLabel39, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 290, 80, 30));
        ...
        add(RegistrarVentaExtranjera, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 600, 240, 60));
        ...
        add(precioVentaKilo, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 300, 170, 30));

        jLabel40.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel40.setText("Por Kilo:");
        add(jLabel40, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 310, 140, 20));

        jLabel41.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel41.setText("Precio de Venta");
        add(jLabel41, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 290, 140, 30));
        ...
        jLabel15.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "INFORMACIÓN DEL IMPORTADOR", javax.swing.border.TitledBorder.LEFT, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Adobe Arabic", 1, 14))); // NOI18N
        ...
        RegistrarVentaExtranjera1.setText("BUSCAR FACTURAS PAPEL EXTRANJERAS");
        ...
        add(RegistrarVentaExtranjera1, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 20, 410, -1));

        jLabel10.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel10.setForeground(new java.awt.Color(0, 102, 102));
        jLabel10.setText("REGISTRO DE VENTA EXTRANJERA");
        ...
        add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 230, 70, 40));
        ...
        add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(730, 520, 190, 60));

        jLabel14.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel14.setText("Fecha de");
        add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 220, 130, 30));
    ...
    private void CargarClienteMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_CargarClienteMouseClicked
        if(FacturaVentaNo.getText().equals("Factura de Venta No.")){
            JOptionPane.showMessageDialog(null, "No se ha cargado factura de venta Papel Extranjera para editar");
        }else{
    ...
    private void label_CargarCP2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_label_CargarCP2MouseClicked
        if(FacturaVentaNo.getText().equals("Factura de Venta No.")){
            JOptionPane.showMessageDialog(null, "No se ha cargado factura Eléctronica de venta Extranjera para editar");
        }else{
                ...
                if(trm.getText().equals("")){
                    ...
                    if(valorTotalDolar.getText().equals("")){
                        ...
                        if(precioVentaKilo.getText().equals("")){
                            ...
                            try{
                                BigDecimal valorTotalDolarI =new BigDecimal(valorTotalDolar.getText()); //validamos que valorTotalDolar de la interfaz sea númerico
                                try{
                                    Float.parseFloat(trm.getText()); //validamos que valorTotalDolar de la interfaz sea númerico
                                                    ...
                                                    if(validarQueCargueAlmenosUnCP()){//Validamos que se cargue al menos un CP, para poder Registrar la Venta.
                                                        ...
                                                        if(validarEnCPCargadosCantidadAVenderSeaMayorACero()){//Validamos que las cantidades de los CP sea mayor a cero
                                                            ...
                                                            try {
                                                                ...
                                                                Logger.getLogger(VentaFacturacionPapel_Editar_BodExtranjera.class.getName()).log(Level.SEVERE, null, ex);
                                                            }
                                                            ...
                                                            //precioVentaKilo.setText(""+(double)Math.round(Double.parseDouble(precioVentaKilo.getText()) * 10000d) / 10000d);
                                                            ...
                                                            ControlDB_VentaFacturacionPapel_EditarFacturaExtranjera controlDB_VentasEditar = new ControlDB_VentaFacturacionPapel_EditarFacturaExtranjera();
                                                            try {
                                                                if(controlDB_VentasEditar.validorCantidadesExistentesBodegaExtranjera(ArrayItemFacturaEditar)){
                                                                    int valorW=controlDB_VentasEditar.registrarVentaExtranjera(facturaVenta, ArrayItemFacturaEditar,user);
                                                                    if(valorW==1){
                                                                        ...
                                                                        generarReportes.generar_FacturaVentaPapelExtranjera(facturaVenta.getId());
                                                                        ...
                                                                        JOptionPane.showMessageDialog(null, "Error al registrar la Venta a Papel");    
                                                                    }
                                                                }else{
                                                                    JOptionPane.showMessageDialog(null, "Error!!. No se puede Registrar la Venta a papel, Verifique nuevamente todos los saldos en bodega debido a que han cambiado. Sugerencia Elimine los CP y vuelva a cargarlos");
                                                                }
                                    ...
                                    alertaDatosFactura.setText("ERROR!!.. La TRM deber ser númericoa, verifique datos ingresados");
                                }
                            }catch(Exception e){
                                alertaDatosFactura.setText("ERROR!!.. El valor Total en Dolar debe ser Númerico, verifique datos ingresados");
                            }                            
                        }
                    }
                }
        ...
        try{
            ...
            if(fila1==-1){
                ...
                try{
                    ...
                    ControlDB_VentaFacturacionPapel_EditarFacturaExtranjera controlDB_Ventas_Editar_Factura_BodExtranjera = new ControlDB_VentaFacturacionPapel_EditarFacturaExtranjera();
                    FacturaVenta facturaVenta =null;
                    ArrayList<ItemFactura> listadoItemFacturas = null;    
                    Cliente cliente =null;
                    try{
                        facturaVenta=controlDB_Ventas_Editar_Factura_BodExtranjera.consultarUnicaFacturasVentasExtranjera(idFacturaVenta);
                        listadoItemFacturas=controlDB_Ventas_Editar_Factura_BodExtranjera.consultarItemFacturasVentasExtranjera(idFacturaVenta);
                        ...
                        cliente= controlDB_Ventas_Editar_Factura_BodExtranjera.retornarCliente(c);
                        ...
                        dex.setText(facturaVenta.getDex());
                        trm.setText(""+facturaVenta.getTrm());                       
                        ...
                        valorTotalDolar.setText(""+facturaVenta.getValorTotalEnDolarIngresados().toPlainString());
                        ...
                        for(int i =0; i< listadoItemFacturas.size(); i++){ 
                           ...
                           IngresoProducto ingresoProducto= controlDB_Ventas_Editar_Factura_BodExtranjera.retornarCompra(listadoItemFacturas.get(i).getIdIngresoProducto());
                            //registroCPX[0]=listadoItemFacturas.get(i).getIdIngresoProducto());
                            registroCPX[0]=ingresoProducto.getCp();
                            
                            registroCPX[1]=controlDB_Ventas_Editar_Factura_BodExtranjera.retornoNombreProducto(ingresoProducto.getProducto_id());
                            registroCPX[2]="Extranjera";
                            
                            Proveedor p = new Proveedor();
                            p.setNit(ingresoProducto.getProveedor_nit());
                            p.setSucursal(ingresoProducto.getProveedor_sucursal());                        
                            Proveedor proveedor = new Proveedor();
                            proveedor= controlDB_Ventas_Editar_Factura_BodExtranjera.retornarProveedor(p);
                            ...
                            cantidadEnBodega = cantidadEnBodega+ Integer.parseInt(controlDB_Ventas_Editar_Factura_BodExtranjera.validarSaldoBodegaExtranejera(""+listadoItemFacturas.get(i).getIdIngresoProducto()));
    ...
    public void BuscarEnVentanaInternaDocumentos(String valorConsulta) throws SQLException{               
        ...
        ControlDB_VentaFacturacionPapel_EditarFacturaExtranjera controlDB_Ventas_Editar_Factura_BodExtranjera = null;
        if(valorConsulta.equals("")){
             controlDB_Ventas_Editar_Factura_BodExtranjera = new ControlDB_VentaFacturacionPapel_EditarFacturaExtranjera();
            listadoVentas=controlDB_Ventas_Editar_Factura_BodExtranjera.consultarFacturasVentasExtranjera(codigoDocumento.getText());
        }else{
            try{
                Integer.parseInt(codigoDocumento.getText());
                controlDB_Ventas_Editar_Factura_BodExtranjera = new ControlDB_VentaFacturacionPapel_EditarFacturaExtranjera();
                listadoVentas=controlDB_Ventas_Editar_Factura_BodExtranjera.consultarFacturasVentasExtranjera(" AND [facturaVenta].[id]='"+codigoDocumento.getText()+"'");
            }catch(Exception e){
        ...
        if(listadoVentas !=null){
            for(int i =0; i< listadoVentas.size(); i++){ 
                ...
                registro[3]="Extranjera"; //+listadoVentas.get(i).getBodegaFacturaVenta_id();
                ...
                registro[5]=""+controlDB_Ventas_Editar_Factura_BodExtranjera.consultarNombreCliente(c);
                registro[6]=""+controlDB_Ventas_Editar_Factura_BodExtranjera.retornarCantidadTotalFacturaVenta(listadoVentas.get(i).getId());
    ...
    public void buscarCP(){
        try{                                         
            ...
            ControlDB_VentaFacturacionPapel_EditarFacturaExtranjera controlDB_Ventas= new ControlDB_VentaFacturacionPapel_EditarFacturaExtranjera();
            ArrayList<IngresoProducto> listadoCp=controlDB_Ventas.consultarCpBodegaExtranjera(codigoCP.getText());
            for(int i =0; i< listadoCp.size(); i++){
                ...
                registroCP[2]=""+controlDB_Ventas.validarNombreBodegaExtranejera(""+listadoCp.get(i).getBodega_ingresoProductoInicial());
                registroCP[3]=""+listadoCp.get(i).getCantidadInicial();
                registroCP[4]=""+controlDB_Ventas.validarSaldoBodegaExtranejera(listadoCp.get(i).getId());
