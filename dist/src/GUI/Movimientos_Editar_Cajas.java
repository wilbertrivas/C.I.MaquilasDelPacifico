...
import Controladores.ControlDB_Movimientos_Editar_Cajas;
...
public class Movimientos_Editar_Cajas extends javax.swing.JPanel {
    String valor="";
    Usuario user;
    ...
    public Movimientos_Editar_Cajas(Usuario u) {
        user= u;
        initComponents();
    ...
    private void initComponents() {
        ...
        VentanaBuscarDocumento.setTitle("Buscar Movimientos de Cajas en Bodega");
        ...
        VentanaBuscarDocumento.getContentPane().add(codigoDocumento, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 30, 290, 30));
        ...
        ventanaInterna_Nombre1.setText("Ingrese el número de documento movimiento cajas");
        ...
        jLabel9.setText("EDITAR MOVIMIENTO DE CAJAS");
        add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 110, 490, 30));
        ...
        RegistrarMovimiento.setText("ACTUALIZAR MOVIMIENTO");
        ...
        BuscarCompra.setText("BUSCAR MOVIMIENTO CAJAS");
    ...
    private void RegistrarMovimientoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RegistrarMovimientoActionPerformed
         try{
            ...
            if(filas <= 0){
                ...
                //ControlDB_Movimientos_Editar_Cajas  controlDB_Movimientos_Camarones = new ControlDB_Movimientos_Editar_Cajas();
                
                //validamos que los saldo en la bodega sigan Igual al orignal################################
                
                ControlDB_Movimientos_Editar_Cajas controlDB_Movimientos= new ControlDB_Movimientos_Editar_Cajas();
                ...
                if(controlDB_Movimientos.validarEstadoSaldoIngresoProducto(saldoOriginalesBodegaExtranjera, saldoOriginalesBodegaNacional, idIngresoProducto)){
                    ...
                    if(controlDB_Movimientos.actualizarSaldosIngresoProducto(saldoBodegaExtranjeraActual, saldoBodegaNacionalActual, idIngresoProducto)){
                        if(controlDB_Movimientos.eliminarMovimiento(idMovimiento)){
                            if(controlDB_Movimientos.validarSaldosBodegasMovimientos(CP,saldoBodegaExtranjeraActual,saldoBodegaNacionalActual)){    
                                int result= controlDB_Movimientos.registrarMovimiento(idMovimiento, fechaMovimiento, CP, saldoBodegaExtranjeraModificado, saldoBodegaNacionalModificado,user, saldoExtranjeraTraslado, saldoNacionalTrasladado,saldoBodegaExtranjeraActual, saldoBodegaNacionalActual);
                                if(result ==6){
                                    ...
                                    try {
                                        listadoMovimientos = controlDB_Movimientos.consultarBodegas_Por_CP(controlDB_Movimientos.retornarId_IngresoProducto(CP));
                                    ...
                                    generarReportes.generar_Movimientos(MovimientoNumero);
                    ...
                    JOptionPane.showMessageDialog(null, "Los saldo han cambiado no se puede Modificar Movimiento");
                }
                //###########################################################################################            
            }
        }catch(Exception e){
    ...
    private void botonBuscarDocumentoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonBuscarDocumentoActionPerformed
        ...
        try {
            ...
            Logger.getLogger(Movimientos_Editar_Cajas.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void Seleccionar_MovimientoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Seleccionar_MovimientoActionPerformed
        ...
        try{
            ...
            if(fila1==-1){
                ...
                ControlDB_Movimientos_Editar_Cajas controlDB_Movimientos= new ControlDB_Movimientos_Editar_Cajas();
                MovimientoProducto movimientoProducto =controlDB_Movimientos.consultarUnicoMovimientoProductoCajas(Integer.parseInt(idMovimiento));
    ...
    /*public void BuscarEnVentanaInternaDocumentos(String valorConsulta) throws SQLException{               
        DefaultTableModel modelo;
        String [] titulo= {"Entrada Alm. No","CP","Nit_Proveedor", "Nombre_Proveedor", "No_Factura","Bodega","Producto","Fecha_Compra","FechaMaxima_Exportación","Cant_Inicial"};
     ...
     public void BuscarEnVentanaInternaDocumentos(String valor) throws SQLException{
            ...
            modelo = new DefaultTableModel(null, titulo);
            ControlDB_Movimientos_Editar_Cajas controlDB_Movimientos= new ControlDB_Movimientos_Editar_Cajas();
            ArrayList<MovimientoProducto> listadoMovimientoProducto =controlDB_Movimientos.consultarListadoMovimientoProductoCajas(valor);
